...
const features = [
  {
    ...
    image: "/landing/st-triage-dashboard.png",
    darkImage: "/landing/st-triage-dashboard.png",
  ...
  },
  {
    ...
    description: "Watch our modular pipeline in action as it processes inputs through multiple stages: image classification, information retrieval, description generation, and severity scoring.",
    image: "/landing/st-triage-dashboard.png",
    darkImage: "/landing/st-triage-dashboard.png",
    alt: "Triage pipeline visualization",
  },
  {
    title: "Explainable Results",
    description: "Get detailed insights into how our AI system reached its conclusions, with clear explanations of the reasoning process and confidence levels at each step.",
    image: "/landing/st-triage-dashboard.png",
    darkImage: "/landing/st-triage-dashboard.png",
    alt: "Explainable AI interface",
  },
  {
    title: "Complete Assessment View",
    description: "Review the full assessment output, including classified condition, retrieved medical information, severity score, and final triage recommendation with next steps.",
    image: "/landing/st-triage-dashboard.png",
    darkImage: "/landing/st-triage-dashboard.png",
    alt: "Complete assessment view",
  }
]
